...
public class FlightCrewMembersValidator extends AbstractValidator<ValidFlightCrewMember, FlightCrewMembers> {
	...
	@Override
	public boolean isValid(final FlightCrewMembers flightCrewMember, final ConstraintValidatorContext context) {
